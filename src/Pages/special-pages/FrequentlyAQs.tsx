        ...
        <div>
            <div>
                ...
                <div className="px-4 py-4 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-8">
                    <div>
                        <p className="font-bold text-3xl">1. Passports</p>
                        <p className="font-bold text-xl py-4">a. My passport is no longer valid. What should I do?</p>
                        <p className="mb-4">
                    ...
                    <div>
                        <p className="font-bold text-xl py-4">b. How can I apply for the replacement of my passport through the Embassy?</p>
                        <p className="mb-4">
                    ...
                    <div>
                        <p className="font-bold text-xl py-4">c. How long will it take for my passport to be ready?</p>
                        <p className="mb-4">
                    ...
                    <div>
                        <p className="font-bold text-xl py-4">d. I have lost my passport what should I do?</p>
                        <p className="mb-4">
                    ...
                    <div>
                        <p className="font-bold text-xl py-4">e. I would like to apply for a first passport for my child. What should I do?</p>
                        <p className="mb-4">
                    ...
                    <div>
                        <p className="font-bold text-xl py-4">f. I would like to apply for a new passport due to change of name. How should I go about it?</p>
                        <p className="mb-4">
                    ...
                    <div>
                        <p className="font-bold text-xl py-4">g. Why do I need a recommender?</p>
                        <p className="mb-4">
                    ...
                    <div>
                        <p className="font-bold text-xl py-4">h. Should I bring my application personally to the Embassy?</p>
                        <p className="mb-4">
                    ...
                    <div>
                        <p className="font-bold text-xl py-4">i. I do not have a passport and have no other documents except a birth certificate. How can I obtain a passport?</p>
                        <p className="mb-4">
                    ...
                    <div>
                        <p className="font-bold text-xl py-4">j. I have been sent by the Ausländerbehörde to come to the Embassy to apply for a passport and need a letter to prove that I was here</p>
                        <p className="mb-4">
                    ...
                    <div className="pt-6">
                        ...
                        <p className="font-bold text-xl py-4">a. Do I need a visa for Kenya? Where can I get the visa?</p>
                        <p className="mb-4">
                    ...
                    <div>
                        <p className="font-bold text-xl py-4">b. How long does it take to process  visa?</p>
                        <li className="mb-4">
                    ...
                    <div>
                        <p className="font-bold text-xl py-4">c. Do I need a Multiple Entry Visa if I wish to re-enter Kenya after travelling to another country?</p>
                        <p className="mb-4">
                    ...
                    <div>
                        <p className="font-bold text-xl py-4">d. I am travelling to Kenya to work as an intern/volunteer or take up employment. What kind of visa do I need?</p>
                        <p className="mb-4">
                    ...
                    <div>
                        <p className="font-bold text-xl py-4">e. I am a frequent traveller. Can I get a Multiple Journey Visa?</p>
                        <p className="mb-4">
                            If travelling often for business purposes or family visit, you can apply for an MJV .
                        </p>
                    </div>
                    <div>
                        <p className="font-bold text-xl py-4">f. Can I get a Visa on arrival in Kenya?</p>
                        <p className="mb-4">
                            No. Visa on arrival is no longer possible since 01.01.2021.
                        </p>
                    </div>
                    <div>
                        <p className="font-bold text-xl py-4">g. I applied for an evisa and haven't received it</p>
                        <p className="mb-4">
                    ...
                    <div>
                        <p className="font-bold text-xl py-4">h. I cannot log into my evisa account</p>
                        <p className="mb-4">
                    ...
                    <div className="pt-6">
                        ...
                        <p className="font-bold text-xl py-4">a. I have to give up my Kenyan citizenship. What should I do?</p>
                        <p className="mb-4">
                        </p>
                        <p className="mb-4">
                    ...
                    <div>
                        <p className="font-bold text-xl py-4">b. How long does it take?</p>
                        <p className="mb-4">
                    ...
                    <div>
                        <p className="font-bold text-xl py-4">c. How can I identify myself or travel if I surrender my passport as I wait for the certificate?</p>
                        <p className="mb-4">
                    ...
                    <div>
                        <p className="font-bold text-xl py-4">d. Will I get my passport (and ID) back when I have renounced?</p>
                        <p className="mb-4">
                            No the Embassy will withdraw and cancel your passport and ID after you have been officially renounced.
                        </p>
                    </div>
                    <div>
                        <p className="font-bold text-xl py-4">e. The German authorities naturalised me and withdrew my passport before I renounced. What should I do?</p>
                        <p className="mb-4">
                    ...
                    <div>
                        <p className="font-bold text-xl py-4">f. Kenya allows dual citizenship. Why must I give up my Kenyan citizenship?</p>
                        <p className="mb-4">
                            You are renouncing upon the behest of the German government. Kindly engage your local German authority on that matter.
                        </p>
                    </div>
                    <div>
                        <p className="font-bold text-xl py-4">g. Can I regain the Kenyan citizenship later?</p>
                        <p className="mb-4">
                    ...
                    <div>
                        <p className="font-bold text-xl py-4">h. We are renouncing as a family. Should I also apply for my under 18 year old child?</p>
                        <p className="mb-4">
                    ...
                    <div>
                        <p className="font-bold text-xl py-4">i. Do I need to have the ePassport to renounce?</p>
                        <p className="mb-4">
                    ...
                    <div className="pt-6">
                        ...
                        <p className="font-bold text-xl py-4">How long does it take to have an Emergency Travel Document issued and what are the requirements?</p>
                        <p className="mb-4">
                    ...
                    <div className="pt-6">
                        ...
                        <p className="font-bold text-xl py-4">a. I wish to marry/get married and have been told to contact the Embassy</p>
                        <p className="mb-4">
                    ...
                    <div>
                        <p className="font-bold text-xl py-4">b. How long will the process take?</p>
                        <p className="mb-4">
                    ...
                    <div>
                        <p className="font-bold text-xl py-4">c. Can I marry/get married or register my marriage at the Embassy</p>
                        <p className="mb-4">

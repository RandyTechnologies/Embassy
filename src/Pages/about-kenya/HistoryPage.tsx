    ...
    return (
        <div>
            ...
            <div className="relative">
                ...
                <div>
                    <p className="absolute inset-0 flex items-center justify-center text-4xl font-bold text-white">History</p>
                </div>
            </div>
            <section className="px-4 py-4 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8">
                <div className="">
                    ...
                    <div className="mt-4">
                        <p className="font-bold text-2xl">Early Visitors</p>
                    ...
                    <div className="mt-4">
                        <p className="font-bold text-2xl">Colonial Rule</p>
                    ...
                    <div className="mt-4">
                        <p className="font-bold text-2xl">Independent Kenya</p>
                        <p className="mb-4">
